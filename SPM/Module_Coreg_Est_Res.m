...
%   
    ...
    user_parameter(:,13)  = {'       .Wrapping','cell',{'No wrap','Wrap X', 'Wrap Y', 'Wrap X&Y', 'Wrap Z', 'Wrap X&Z', 'Wrap Y&Z', 'Wrap X,Y&Z'},'Wrapping','','',...
    ...
    user_parameter(:,14)  = {'       .Masking','cell',{'Mask images', 'Dont mask images'},'Masking','','',...
