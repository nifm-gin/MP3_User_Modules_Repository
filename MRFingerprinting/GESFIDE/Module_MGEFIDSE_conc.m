function [files_in,files_out,opt] = Module_MGEFIDSE_conc(files_in,files_out,opt)
...
if isempty(opt)
    ...
    user_parameter(:,12)  = {'   .Model settings (if the DBL method is used):','Text','','','','',...
        {'Recommanded:'
        'K = 50'
        'Lw = 0'
        'cstr on Sigma = ''d*'''
    ...
    user_parameter(:,17)   = {'       .Dictionary augmentation?','numeric','', 'augment', '', '',...
        {'Recommanded: SNR = 60'
