function [Yestim, score, Xestim] = EstimateParametersOnFlyPar(Xobs, Xgrid, Ygrid, geo, Ylabels)
...
ps.SchedulerComponents(1).NumWorkers = 64;
ps.SchedulerComponents(1).NumThreads = 2;
