...
if any(contains(fields(files_in), 'In3')) %if a mask is given
    system(['bash ' s 'MP3_pipeline/Modules/MP3_User_Modules_Repository/ANTs/ANTs/sync_atlas.sh' ...
...
if ~isempty(transf0) && isempty(transf1)
    system(['bash ' s 'MP3_pipeline/Modules/MP3_User_Modules_Repository/ANTs/ANTs/apply_transformation.sh' ...
            ' -s ' opt.script_location ...
            ' -d ' opt.dimension ...
